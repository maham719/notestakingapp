...
// firebase signup 
  ...
  .then((userCredential) => {
    ...
    notyf.success("Account Created Sucessfully login to continue")
    // ...
  })
  .catch((error) => {
    const errorCode = error.code;
  ...
  <div className="grid md:grid-cols-2 items-center gap-4 lg:gap-8 h-[80vh] w-[90%] m-auto">
    ...
    <div className="flex items-center p-3 h-full w-full ">
      <form className="max-w-lg w-full mx-auto" onSubmit={(e)=>handlesignup(e)}>
        <div className="mb-12">
        ...
        <Button
         ...
         {/* Social Login Buttons */}
                ...
                <div className="space-x-8 flex justify-center">
                  <button type="button" className="border-0 outline-0 cursor-pointer" onClick={googlesignin}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
